...
Contents
 ...
 - source code in C to create the data library
 - man pages (in man/ directory)
 - a test program (in test/ directory) is built
   with the library
 - a public include file data.h
...
Compile MinilibX
 ...
 - run ./configure or make
   ...
   test/data-test binary is also created.
...
Install MinilibX
 ...
 - no installation script is provided. You may want to install
     ...
     - data.h in /usr/X11/include or /usr/local/include
     - man/man3/data*.1 in /usr/X11/man/man3 or /usr/local/man/man3
